...
pub fn createRenderPass(
    ...
    const mesh_info_buffer = try render_graph.importBuffer(resources.meshes2.mesh_info_buffer);
    ...
    if (self.indirect) {
        ...
        build_data.* = .{
            ...
            .vertex_buffer = try render_graph.importBuffer(resources.meshes2.vertex_buffer.buffer),
            .index_buffer = try render_graph.importBuffer(resources.meshes2.index_buffer.buffer),
