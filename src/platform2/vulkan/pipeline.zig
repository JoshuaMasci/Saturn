...
pub fn createGraphicsPipeline(
    ...
    const depth_stencil = vk.PipelineDepthStencilStateCreateInfo{
        .depth_test_enable = if (desc.depth_stencil_state.depth_test_enable) .true else .false,
        .depth_write_enable = if (desc.depth_stencil_state.depth_write_enable) .true else .false,
        .depth_compare_op = toVkCompareOp(desc.depth_stencil_state.depth_compare_op),
...
pub fn createComputePipeline(
    device: *const Device,
    desc: *const saturn.ComputePipelineDesc,
) PipelineError!vk.Pipeline {
    var pipeline: vk.Pipeline = undefined;
    ...
    const pipeline_info: vk.ComputePipelineCreateInfo = .{
        ...
        .stage = .{
            ...
            .module = device.shader_modules.get(desc.shader).?,
            .p_name = "main",
            .p_specialization_info = null,
        },
    };
